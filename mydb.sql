...
494	2023-10-30 12:34:46.322076+05:30	LM0006402
\.
...
COPY public.admin (id, email, password) FROM stdin;
2	jeevanreddy@gmail.com	69afceb838754fd9.f5a1a2b1523412ece05b1776091a04a086adf4bf928e1418e99e2e6d0d377c12
\.
...
SELECT pg_catalog.setval('public.city_id_seq', 22, true);
